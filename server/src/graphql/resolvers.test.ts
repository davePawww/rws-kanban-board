...
describe('Mutation', () => {
  ...
  describe('createColumn', () => {
    it('inserts a column with auto-calculated position', async () => {
      const existingColumns = [{ id: 'col-1', boardId: 'board-1', title: 'Todo', position: 0 }];
  ...
  describe('createCard', () => {
    it('inserts a card with auto-calculated position', async () => {
      ...
      const result = await resolvers.Mutation.createCard(null, {
        columnId: 'col-1',
        title: 'Task 3',
        description: 'More work',
      });
  ...
  describe('updateCardPosition', () => {
    it('updates card column and position', async () => {
      ...
      const result = await resolvers.Mutation.updateCardPosition(null, {
        id: 'card-1',
        columnId: 'col-2',
        position: 0,
      });
